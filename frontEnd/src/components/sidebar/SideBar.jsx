    ...
    return (
        <aside className="flex flex-col h-full w-64 bg-navy-900 shadow-sidebar">
            ...
            <div className="px-3 py-4 border-t border-navy-700/50">
                <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-navy-700/40 transition-colors">
                    <div className="w-8 h-8 rounded-full bg-azure-600/20 border border-azure-500/30 flex items-center justify-center flex-shrink-0">
                        <span className="text-xs font-semibold text-azure-400">{getInitials(salarie?.prenom, salarie?.nom)}</span>
                    </div>
