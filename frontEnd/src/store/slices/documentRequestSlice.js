...
export const fetchDocumentRequests = createAsyncThunk(
    ...
    async (params, { rejectWithValue }) => {
        try {
            ...
            const { data } = await documentRequestApi.getAll(newParams)
            return data
        } catch (err) {
...
export const selectMyDocumentRequests = (s) => s.documentRequest.myRequests
export const selectMyDocumentRequestTotal = (s) => s.documentRequest.myRequestsTotal
